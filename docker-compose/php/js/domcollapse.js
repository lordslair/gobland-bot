...
dc={
	...
	*/
	...
	makeTrigger:function(o,e){
		...
		*/
		if(o.nodeName=='TR') {
			var trCells = o.getElementsByTagName('th');
			if(trCells.length == 0) {
				trCells = o.getElementsByTagName('td');
			}
			trCells[0].insertBefore(tl, trCells[0].firstChild);
		} else {
...
addEvent(window, 'DOMContentLoaded', dc.init);
